...
\begin{figure*}[ht]
\centering
\includegraphics[width=.8\textwidth]{BoscoRImages/ArchitectureGraph1.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.4\textwidth]{BoscoRImages/InputDiagram.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.5\textwidth]{BoscoRImages/30minplot.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.5\textwidth]{BoscoRImages/ComparisonPlot.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.5\textwidth]{BoscoRImages/NumberRunning.pdf}
