...
Some of these job attributes can be extracted from the job submission files.  Input files that are shared between multiple executions can be categorized as shared.  
