...
Experimental data could also be shared between multiple jobs in a job set.  
 ...
 Experimental data such as input databases which will be queried by each job.  The queries may be unique per job, but the database job.  An example of this is BLAST \cite{altschul1990basic}.
