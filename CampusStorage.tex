...
A user creates their submit file and specifies their data.  The above policies will can be matched to syntax in the submit file.  In this case I use the syntax:
