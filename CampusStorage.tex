...
The sandbox is different from input data as the input data could be unique per job.  Shared data between many execution can benefit from caching, where unique input data cannot benefit from caching.
