...
It is difficult to measure the increase in productivity of researchers.  A survey could be performed to aggregate the opinions of researchers in regards to Bosco and CacheD.  Additionally, we could measure how long it takes researchers to start with a local application, and convert it to run on the campus's distributed resources.
