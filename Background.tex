...
The user must wait for the BLAST jobs to complete before checking the results.  If the user has more BLAST jobs to process, they may submit yet more jobs to the cluster.
