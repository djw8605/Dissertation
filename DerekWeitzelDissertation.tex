...
Combining easy-to-use campus job submission with Bosco, efficient data distribution with the CacheD, and a policy language to manage the data distribution, I have created a unified framework for campus computing.
